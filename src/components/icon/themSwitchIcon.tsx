...
export const DarkIcon = (props: Partial<CustomIconComponentProps>) => (
  <Icon component={DarkSvg} {...props} />
)

export const LightIcon = (props: Partial<CustomIconComponentProps>) => (
  <Icon component={LightSvg} {...props} />
)

export const FollowSysyemIcon = (props: Partial<CustomIconComponentProps>) => (
  <Icon component={AutoModeSvg} {...props} />
)
